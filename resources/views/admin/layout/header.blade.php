        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index3.html" class="nav-link">{{ trans('dashb.Home') }}</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://github.com/Abdelrhman-Elnagar" class="nav-link">{{ trans('dashb.Contact') }}</a>
                </li>
            ...
            <form class="form-inline ml-3">
                <div class="input-group input-group-sm">
                    <input class="form-control form-control-navbar" type="search"
                        placeholder="{{ trans('dashb.Search') }}" aria-label="Search">
            ...
            <div>
                <li class="nav-item d-none d-sm-inline-block ml-2">
                    <a href="#" class="btn btn-block btn-danger">{{ trans('dashb.Logout') }}</a>
                </li>
            </div>
